...
public class ebs_serviceTest {
    ...
    public void TestPortInjection() throws InterruptedException {
        ...
        int ebsport = ebs.Client.getPort();
        int echoport = echo.Client.getPort();
        assertEquals(11223, ebsport);
        assertEquals(15555, echoport);
        //ebs.abstractions.Client.sendAsync("Hi".getBytes(), echo.URL);
        //Thread.sleep(1000);
    }
